...
[Full list](https://github.com/alberto-monteiro/blynk-server/blob/master/server/core/src/main/java/cc/blynk/server/core/protocol/enums/Command.java#L11) 
...
[Here is the class with all of the codes](https://github.com/alberto-monteiro/blynk-server/blob/master/server/core/src/main/java/cc/blynk/server/core/protocol/enums/Response.java#L12).
...
[List is here](https://github.com/alberto-monteiro/blynk-server/blob/master/server/core/src/main/java/cc/blynk/server/core/model/enums/WidgetType.java#L8).
...
it is easy understand what is going on there. You may start from [this](https://github.com/alberto-monteiro/blynk-server/blob/master/integration-tests/src/test/java/cc/blynk/integration/tcp/MainWorkflowTest.java#L78) test.